...
async function UniswapV3DeploymentFixture() {
    ...
    return { uniswapV3Deployer, weth, uniswapFactory, tokenDescriptor, positionManager, swapRouter01, swapRouter02, quoter01, quoter02, tickLens, interfaceMulticall };
}

module.exports = { UniswapV3DeploymentFixture };