...
|---|---|---|
| Multicall2 | compiled locally using `solc.compilers.json:multicall2` | [github/sky-ecosystem/multicall](https://github.com/sky-ecosystem/multicall)
...
| @uniswap/Permit2 | compiled locally using `solc.compilers.json:permit2` | [github/@uniswap/permit2](https://github.com/Uniswap/permit2)